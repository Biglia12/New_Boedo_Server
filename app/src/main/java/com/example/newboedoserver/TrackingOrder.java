...
import com.example.newboedoserver.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if (mLastLocation != null) {
                ...
                //agregar marcado in su ubicacion y mover la camara
    ...
    private void drawRoute(LatLng yourLocation, String direccion) {
        mService.getGeoCode(direccion).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Orden de" + Common.currentRequest.getTelefono())
                    ...
                    mService.getDirections(yourLocation.latitude + "," + yourLocation.latitude,
                            ...
                            .enqueue(new Callback<String>() {
                                @Override
                                public void onResponse(Call<String> call, Response<String> response) {
                                    new ParserTask().execute(String.valueOf(response.body()));
                                }
